...
if __name__ == "__main__":
    ...
    while True:
        ...
        if usr_input in ["y", "yes"]:
            ...
            print(
                f"The time now is {pom.pomodoro_start}, and you have until {pom.pomodoro_end}. This is the total of {time_remaining} seconds."
            )
            ...
            print("Starting break")
            print(
                f"The number of checkmarks is {pom.checkmarks} and the number of breaks is {pom.breaks}"
            )
            while True:
